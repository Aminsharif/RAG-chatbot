...
from app.crud.user import create_user, get_user_by_username, assign_role_to_user, RoleCreate, PermissionCreate
...
DATABASES = {
    'default': {
        ...
        'DEFAULT_PASSWORD': os.getenv('DEFAULT_POSTGRES_PASSWORD', '123456'),
